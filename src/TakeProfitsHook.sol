...
contract TakeProfitsHook is BaseHook, ERC1155 {
    ...
    // Errors
    error TakeProfitsHook_InvalidOrder();
    error TakeProfitsHook_NothingToClaim();
    error TakeProfitsHook_NotEnoughToClaim();
    ...
    function cancelOrder(
        ...
        if (positionTokens < amountToCancel)
            revert TakeProfitsHook_NotEnoughToClaim();
    ...
    function redeem(
        ...
        if (claimableOutputTokens[orderId] == 0)
            revert TakeProfitsHook_NothingToClaim();
